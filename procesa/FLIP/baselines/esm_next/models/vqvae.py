...
from ..layers.codebook import EMACodebook
from ..layers.structure_proj import Dim6RotStructureHead
from ..layers.transformer_stack import TransformerStack
from ..utils.constants import esm3 as C
from ..utils.misc import knn_graph
from ..utils.structure.affine3d import (
    Affine3D,
    build_affine3d_from_coordinates,
)
from ..utils.structure.predicted_aligned_error import (
