...
from ..tokenization import EsmSequenceTokenizer
from ..utils import encoding
from ..utils.constants.models import ESMC_600M
from ..utils.decoding import decode_sequence
from ..utils.misc import stack_variable_length_tensors
from ..utils.sampling import _BatchedESMProteinTensor
...
class ESMC(nn.Module, ESMCInferenceClient):
    ...
    def from_pretrained(
        ...
        from ..pretrained import load_local_model
    ...
    def forward(
        ...
        x, _, hiddens, attentions = self.transformer(x, sequence_id=sequence_id)
        sequence_logits = self.sequence_head(x)
        # output = ESMCOutput(
        #     sequence_logits=sequence_logits, embeddings=x, hidden_states=hiddens
        # )
        return sequence_logits, x, hiddens, attentions
